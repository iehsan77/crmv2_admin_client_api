...
const AddEdit = ({ isOpen, onClose, onSave, record }) => {
  ...
  const addTitle = "Add " + model;
  const editTitle = "Edit " + model;
  const addRecordUrl = ecom_endpoints.products.warehouses.create;
  // PAGE RELATED - ending
    ...
    !loading && (
      ...
      >
        <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="grid lg:grid-cols-1">
            <InputControl name="address" type="text" placeholder="address" />
          </div>

          <div className="grid lg:grid-cols-1 my-3">
            <InputControl
              name="working_hours"
              type="text"
