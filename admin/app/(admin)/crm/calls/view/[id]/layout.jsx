...
import LeftSidebar from "@/partials/crm/calls/view/LeftSidebar";

import useCallsStore from "@/stores/crm/useCallsStore";

const Layout = ({ children }) => {
  const { id } = useParams();
  const fetchRecordDetails = useCallsStore((s) => s.fetchRecordDetails);
  const recordDetails = useCallsStore((s) => s.recordDetails);
