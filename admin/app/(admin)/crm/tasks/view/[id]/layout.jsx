...
import LeftSidebar from "@/partials/crm/tasks/view/LeftSidebar";

import useTasksStore from "@/stores/crm/useTasksStore";

const Layout = ({ children }) => {
  const { id } = useParams();
  const fetchRecordDetails = useTasksStore((s) => s.fetchRecordDetails);
  const recordDetails = useTasksStore((s) => s.recordDetails);
