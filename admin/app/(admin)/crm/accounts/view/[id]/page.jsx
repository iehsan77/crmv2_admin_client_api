...
import OverviewTabPage from "@/partials/crm/accounts/view/overview/OverviewTabPage";
...
import useAccountsStore, { useAccountsTabsStore } from "@/stores/crm/useAccountsStore";
      ...
      <div>
        ...
        {selectedTab === "tab2" && (
          <>
            ...
            {/* {selectedSubTab === "subTab3" && <AttachmentsList records={record?.attachments} />} */}
