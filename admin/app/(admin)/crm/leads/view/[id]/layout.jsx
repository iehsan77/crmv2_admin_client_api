...
import LeftSidebar from "@/partials/crm/leads/view/LeftSidebar";

import useLeadsStore from "@/stores/crm/useLeadsStore";

const Layout = ({ children }) => {
  const { id } = useParams();
  const fetchRecordDetails = useLeadsStore((s) => s.fetchRecordDetails);
  const recordDetails = useLeadsStore((s) => s.recordDetails);
