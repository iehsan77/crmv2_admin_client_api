...
import LeftSidebar from "@/partials/crm/meetings/view/LeftSidebar";
...
const Layout = ({ children }) => {
  const { id } = useParams();
  const fetchRecordDetails = useMeetingsStore((s) => s.fetchRecordDetails);
  const recordDetails = useMeetingsStore((s) => s.recordDetails);
