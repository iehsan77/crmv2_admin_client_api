...
export default function FormulaInput({
  ...
  return (
    <div className="mb-4 group">
      ...
      <div
        className={`relative rounded-md shadow-sm border border-gray-300 bg-gray-50 focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500 transition-all duration-200 ${
          required
      ...
      >
        ...
        <input
          readOnly
          {...props}
          className="text-sm block w-full pl-10 pr-3 py-2 rounded-md bg-transparent focus:outline-none text-gray-500 cursor-not-allowed"
        />
        {/* Tooltip */}
        {tooltip && (
