...
} from "@/stores/rentify/useModelsStore";
...
const ModelFilterForm = ({ isDrawer = false }) => {
  ...
  const { updateFilterValue, filterValues } = useModelsFiltersStore();
    ...
    >
      <DropdownFilter
        ...
        onChange={(val) => {
          ...
          updateFilterValue("model_id", null); // reset model on brand change
        }}
        isLoading={loading}
      />
