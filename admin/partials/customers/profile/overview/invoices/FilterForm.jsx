...
import { useFiltersStore } from "@/stores/customers/useCustomerInvoiceStore";
...
const FilterForm = ({ isDrawer = false }) => {
  ...
  return (
    ...
    >
      ...
      {/* Invoice Date Filter */}
      {filterMapValues.includes("invoice_date") && (
        <DropdownFilter
          label="Invoice Date"
          options={[
          ...
          onChange={(val) => updateValue("invoice_date", val)}
        />
      )}

      {/* Invoice Due Date Filter */}
      {filterMapValues.includes("invoice_due_date") && (
        <DropdownFilter
          ...
          onChange={(val) => updateValue("invoice_due_date", val)}
        />
      )}
