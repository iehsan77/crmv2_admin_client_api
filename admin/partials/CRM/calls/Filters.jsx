...
const Filters = () => {
  ...
  //const setPage = useCallsStore((s) => s.setPage);
  const fetchRecords = useCallsStore((s) => s.fetchRecords);
  const setTodayDate = useCallsStore((s) => s.setTodayDate);
  ...
  return (
    <>
      ...
      <ViewsTabs
        onTabChange={fetchRecords}
        useStore={useCallsStore}
        viewsStore={useCallsViewTabsStore}
      />
