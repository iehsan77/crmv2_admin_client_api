...
export default function RecordForm({ record = {} }) {
  ...
  const saveRecord = useLeadsStore((s) => s.saveRecord);
  const updateRecord = useLeadsStore((s) => s.updateRecord);
...
export const FormSchema = z.object({
  ...
  title: requiredString("Lead Title"),

  owner_id: requiredString("Lead Owner"),
  assigned_to_id: requiredString("Assigned To"),

  source_id: requiredString("Lead Source"),
  ...
  role_id: requiredString("Lead Role"),
