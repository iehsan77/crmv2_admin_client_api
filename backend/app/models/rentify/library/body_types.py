...
@form_body
class BodyTypeCreate(BodyTypesBase):
    ...
    security_deposit: Optional[int] = Field(default=0)
...
@form_body
class BodyTypeUpdate(BodyTypesBase):
    id: Optional[int] = Field(default=0)
    logo: Optional[str] = Field(default="")
    title: Optional[str] = Field(default="")
    slug: Optional[str] = Field(default="")
...
class BodyTypeInDB(BodyTypesBase):
    id: int
