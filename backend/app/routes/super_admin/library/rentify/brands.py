...
library_rentify_brands = APIRouter(tags=["Super Admin > Library > Rentify > Brands"])
...
from app.models.super_admin.library.rentify.brands import BrandCreate, BrandUpdate
...
# ================================
@library_rentify_brands.post("/library/rentify/brands/save")
...
@library_rentify_brands.post("/library/rentify/brands/get")
async def get_brands(user_detail: dict = Depends(oauth2.get_user_by_token)):
    try:
        results = list(
            collection
        ...
        for result in results:
            result["origin_country"] = getCountryById(int(result.get("origin_country_id")))   
...
@library_rentify_brands.post("/library/rentify/brands/get/{id}")
async def get_brand_by_id(id: int, user_detail: dict = Depends(oauth2.get_user_by_token)):
    try:
...
@library_rentify_brands.get("/library/rentify/brands/{id}/deleted/{value}")
